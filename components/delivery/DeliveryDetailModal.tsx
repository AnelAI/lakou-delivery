          ...
          <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
            ...
            {delivery.notes && (
              <div className="flex items-start gap-3 bg-yellow-50 border border-yellow-100 rounded-xl px-4 py-3">
                <FileText size={15} className="text-yellow-600 flex-shrink-0 mt-0.5" />
            ...
            {delivery.courier && (
              <div className="flex items-center gap-3 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
                ...
                <div>
                  <p className="text-xs text-blue-600 font-semibold">Coursier assigné</p>
                  <p className="text-sm font-bold text-gray-800">{delivery.courier.name}</p>
                </div>
              </div>
            )}
